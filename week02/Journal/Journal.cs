// This handles journal entries and file operations
using System;
...
public class Journal
{
    ...
    public void WriteNewEntry()
    {
        ...
        string prompt = _prompts[random.Next(_prompts.Count)]; //This gives you a single prompt randomly from my list of prompts 
